/**
 * Plasma Background Component — WebGL shader effect via OGL.
 * Adattato da spec utente per Quickufficio. Lazy-loaded come React island in Astro.
 */
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      if (direction === 'pingpong') {
        ...
        const pingpongTime =
          segmentTime > pingpongDuration ? pingpongDuration * 2 - segmentTime : segmentTime;
